...
//⌄ enclosing_range_start semanticdb maven jdk 11 java/util/Iterator#
//       ⌄ enclosing_range_start semanticdb maven . . java/
//       ⌄ enclosing_range_start semanticdb maven . . java/util/
  import java.util.Iterator;
//       ^^^^ import semanticdb maven . . java/
//            ^^^^ import semanticdb maven . . java/util/
//                 ^^^^^^^^ import semanticdb maven jdk 11 java/util/Iterator#
//               ⌃ enclosing_range_end semanticdb maven . . java/
//                        ⌃ enclosing_range_end semanticdb maven . . java/util/
...
//                    ⌄ enclosing_range_start semanticdb maven jdk 11 java/lang/Iterable#
//                    ⌄ enclosing_range_start semanticdb maven . . minimized/ParameterizedTypes#[A]
//                                  ⌄ enclosing_range_start semanticdb maven jdk 11 java/util/Iterator#
//                                  ⌄ enclosing_range_start semanticdb maven . . minimized/ParameterizedTypes#[B]
//                                                                 ⌄ enclosing_range_start semanticdb maven jdk 11 java/util/List#
