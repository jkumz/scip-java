...
//           ⌄ enclosing_range_start local 1
//           ⌄ enclosing_range_start semanticdb maven jdk 11 java/util/function/Function#apply().
//           ⌄ enclosing_range_start local 0
      return fn.apply(n);
//           ^^ reference read_access local 1
//              ^^^^^ reference read_access semanticdb maven jdk 11 java/util/function/Function#apply().
//                    ^ reference read_access local 0
//                  ⌃ enclosing_range_end local 1
//                     ⌃ enclosing_range_end semanticdb maven jdk 11 java/util/function/Function#apply().
//                     ⌃ enclosing_range_end local 0
    }
